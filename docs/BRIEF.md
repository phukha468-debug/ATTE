...
- [ ] **UI Polish (Next):** Балансировка размеров, исправление маппинга баллов по темам, параллакс-эффекты для "королевских" результатов (>80%).

### Фаза 2: Обучающая среда (В РАЗРАБОТКЕ)
- [ ] **Симулятор (Этап 2):** Интерактивная песочница с ИИ-агентом для отработки промптов в реальном времени.
- [ ] **Микро-проекты (Этап 3):** Пошаговые задания по автоматизации конкретных рабочих процессов.
